...
public class VoxelWriter {
    ...
    public void write(List<OctreeNode> leafNode, String path) throws IOException{
        ...
        writer.write("SUCCESS | Output berada pada \"" + path + "\"");
    ...
    private void writeObj(BufferedWriter writer, Vector3 min, Vector3 max) throws IOException{
        Vector3[] v = {new Vector3(min.x, min.y, min.z), new Vector3(max.x, min.y, min.z), new Vector3(max.x, max.y, min.z), new Vector3(min.x, max.y, min.z), new Vector3(min.x, min.y, max.z), new Vector3(max.x, min.y, max.z), new Vector3(max.x, max.y, max.z), new Vector3(min.x, max.y, max.z)};
